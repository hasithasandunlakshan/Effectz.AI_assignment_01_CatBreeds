    ...
    <footer className="bg-black text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div className="mb-8 md:mb-0">
            ...
            <p className="text-gray-400 mb-4">
              Discover the wonderful world of cats with our comprehensive guides, 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Cat Breeds</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Cat Care</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Health & Nutrition</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Training</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Adoption</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <input
                ...
                className="px-4 py-2 bg-gray-900 border border-gray-800 rounded focus:outline-none focus:ring-1 focus:ring-white"
              />
              <button
                type="submit"
      ...
      <div className="bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© {new Date().getFullYear()} CatWorld. All rights reserved.</p>
